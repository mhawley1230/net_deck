...
driver.navigate.to 'http://mtgtop8.com/'

4.times do |i|
  f = driver.find_elements(:xpath, "/html/body/div[2]/div/table/tbody/tr[#{i+1}]/td/a")
  f.click
    ...
    deck_length.times do |i|
      ...
      deck.each do |list|
        ...
        Card.create!( name: card_name, colors: card_colors, number_played: number_played,
          img_url: card_img, main?: main, true: current_deck.id )
      end
    end
