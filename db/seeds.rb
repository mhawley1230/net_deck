...
driver.navigate.to 'http://mtgtop8.com/format?f=VI'

t = driver.find_element(:xpath, "/html/body/div[3]/div/table/tbody/tr/td[2]/table[2]/tbody/tr[8]/td[1]/a")
t.click
...
deck_length.times do |i|
  ...
  deck = deck.push(main_deck).push(main_deck_0).push(side_board)
